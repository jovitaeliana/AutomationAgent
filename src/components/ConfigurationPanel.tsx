...
const ConfigurationPanel: React.FC<ConfigurationPanelProps> = ({ selectedNode, onClose }) => {
  ...
  return (
    <aside className="w-1/3 max-w-sm bg-app-bg-content border-l border-app-border flex flex-col p-4">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* In a real app, you'd show a dynamic form based on the node type */}
